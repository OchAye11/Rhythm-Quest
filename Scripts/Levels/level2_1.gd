...
func _on_end_timer_timeout() -> void:
	...
	Global.level_3 = true
	Global.next_dialogue = "res://Dialogue/level_select_2_1.json"
	Global.been_lost_1 = true
	Global.can_talk = true
	
func _on_dialogue_timer_timeout() -> void:
	$DialoguePlayer.dialogue_file = "res://Dialogue/level_2_1_end.json"
	$DialoguePlayer.start()
	get_tree().paused = true
