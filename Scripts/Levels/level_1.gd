...
func _on_end_timer_timeout() -> void:
	$Scoreboard.start()
	Global.level2_1 = true
	Global.level2_2 = true
	Global.level_1 = false
	Global.can_talk = true

func _on_dialogue_timer_timeout() -> void:
	$DialoguePlayer.dialogue_file = "res://Dialogue/level_1_end.json"
	$DialoguePlayer.start()
	get_tree().paused = true
...
func light_effect():
	...
	if chest_visible:
		$TimerContainer/ChestTimer.start()
	chest_visible = true
