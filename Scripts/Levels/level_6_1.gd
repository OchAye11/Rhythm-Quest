...
var rand: int = 0
var circle_num: int
var ring = load("res://Objects/Game/moving_rings.tscn")
...
func _on_ready() -> void:
	...
	if Global.dropped_axe:
		$Up_Ring_Icon/AnimationPlayer.play("Up_Ring")
		$Right_Ring_Icon/AnimationPlayer.play("Right_Ring")
		$Down_Ring_Icon/AnimationPlayer.play("Down_ring")
		$Left_Ring_Icon.visible = true
		$Up_Ring_Icon.visible = true
		$Right_Ring_Icon.visible = true
		$Down_Ring_Icon.visible = true
...
func _on_end_timer_timeout() -> void:
	$Scoreboard.start()
	Global.level6_1 = false
	Global.level6_2 = false
	Global.level_7 = true
	Global.next_dialogue = "res://Dialogue/level_select_6_1.json"
	Global.choice_6_1 = true
	if Global.dropped_axe:
		Global.magic_used = true
	else:
		Global.tree_cut_2 = true
